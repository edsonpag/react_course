    ...
    return (
        <div className="tweet-container">
            <div className="col-a">
                ...
                alt="Profile"
                className="tweet-profile-photo"
                />
            </div>
            <div className="col-b">
                <div className="line-1">
                    <span className="retweet-text">100DaysOfCode Reteweeted</span>
                </div>
                <div className="line-2">
                    <h4 className="tweet-name">Marcos Correa</h4>
                    <span className="tweet-login">@mcorrea_jr</span>
                    <span className="tweet-time">· 5h</span>
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="tweet-options-icon">
                        <g>
                ...
                <div className="line-3">
                    <p className="tweet-text">Estou pensando em fazer uma live hoje para tirar duvidas lá no canal da Suno. Se tiver alguma, deixa um comentario aqui.</p>
                </div>
